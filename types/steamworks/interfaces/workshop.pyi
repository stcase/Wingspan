...
class SteamWorkshop:
    ...
    def CreateItem(self, app_id: int, filetype: EWorkshopFileType, callback: object = ..., override_callback: bool = ...) -> None: ...
    def SubscribeItem(self, published_file_id: int, callback: object = ..., override_callback: bool = ...) -> None: ...
    def UnsubscribeItem(self, published_file_id: int, callback: object = ..., override_callback: bool = ...) -> None: ...
    ...
    def SubmitItemUpdate(self, update_handle: int, change_note: str, callback: object = ..., override_callback: bool = ...) -> None: ...
    ...
    def GetSubscribedItems(self, max_items: int = ...) -> list: ...
    def GetItemState(self, published_file_id: int) -> EItemState: ...
    def GetItemInstallInfo(self, published_file_id: int, max_path_length: int = ...) -> dict: ...
