...
class SteamUtils:
    ...
    def ShowGamepadTextInput(self, input_mode: EGamepadTextInputLineMode, line_input_mode: EGamepadTextInputMode, description: str, max_characters: int, preset: str) -> bool: ...
